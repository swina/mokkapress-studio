...
<script>
import productsQry from '@/apollo/products.gql'
...
export default {
    ...
    mounted(){
        console.log ( this.$attrs.el.plugin )
        this.lang = language[navigator.language||'en']
        if ( this.$attrs.el.plugin.config.mode != 'static' ){
