<template>
    <div class="w-full flex flex-col">
        ...
        <!-- link and anchor -->
        <div class="bg-gray-400 cursor-pointer hover:bg-blue-300 text-gray-800 px-1" @click="setOpt('link')">
            Link / Anchor
        </div>
        <transition name="fade">
        ...
        <div v-if="$attrs.element.tag === 'input'" class="flex flex-col">
         ...
         <!-- Semantic  -->
        <div class="bg-gray-400 cursor-pointer hover:bg-blue-300 text-gray-800 px-1 mt-1" v-if="$attrs.entity && editor.current.tag != 'document'" @click="setOpt('semantic'),semantic=!semantic">
            HTML Semantic
        </div>
        <moka-options 
            class="mb-2" 
