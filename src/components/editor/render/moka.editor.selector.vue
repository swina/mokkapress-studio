...
<div class="w-full h-auto pb-10 mb-10 top-0 left-0 relative" data="init">
    ...
    <div v-else>
        ...
        <!-- SLIDER -->
        <div v-if="doc && $attrs.category === 'slider'" :data="getSlider">
    ...
    <div editorstatus class="fixed bg-gray-300 z-top bottom-0 left-0 p-1 border-t w-full flex flex-row items-center text-sm bg-white z-max uppercase h-10 divide-x divide-gray-400">
        ...
        <div v-if="editor.current" class="pl-1 w-full flex flex-row items-center">
            ...
            <input v-if="editor.current && !editor.current.css.hasOwnProperty('css')" type="text" class="ml-2 w-2/5" v-model="editor.current.css"/>
            ...
            <i class="material-icons moka-icon-circle ml-2" title="Customize" @click="$action('customize')">brush</i>
    ...
    <transition name="fade">
        <div class="z-xtop fixed bg-gray-800 text-gray-400 bottom-0 right-0 w-3/12 p-2 border shadow bg-white" v-if="editCSS">
            ...
            <div>CSS</div>
            <textarea v-if="editor.current && !editor.current.css.hasOwnProperty('css')" class="dark w-full h-32 text-gray-400" v-model="editor.current.css"/>
            ...
            <textarea v-if="editor.current && editor.current.css.hasOwnProperty('css')" class="dark w-full h-32 text-gray-400" v-model="editor.current.css.container"/>
    ...
    <moka-editor-actions :action="editor.action" v-if="editor.action"/>
    ...
    <transition name="fade">
        <div v-if="editor.action==='formsetting'" class="nuxpresso-modal w-full md:w-1/3 border-t-8 border-gray-700 z-2xtop p-2 bg-white rounded-l shadow border">
            <i class="material-icons absolute right-0 m-1" @click="$action()">close</i>
            <h4>Form settings</h4>
            <div class="flex flex-col">
                ...
                <button class="success m-auto w-12 my-2" @click="$action()">OK</button>
            </div>
        </div>
    </transition>
    -->
    ...
    <transition name="fade">
        <moka-modal
            ...
            size="lg"
            buttons="close"
            v-if="editor.action==='popupsettings' && editor.current && editor.current.hasOwnProperty('popup')"
            @close="$action()"
            @click_0="$action()"
            >
    ...
    <transition name="fade">
        <moka-modal
            ...
            size="lg"
            buttons="close"
            v-if="editor.action==='pluginsetting' && editor.current && editor.current.type==='plugin'"
            @close="$action()"
            @click_0="$action()"
            >
